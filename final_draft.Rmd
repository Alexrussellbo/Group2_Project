...
plt.show()
```
![Caption for the picture.](figures/scree_python.png)
...
![eigenvalues](figures/table1.png)
...
![Parallel Analysis](figures/parallel.png)
...
![Factor Loadings](figures/picture1.png)
